...
#define dispAmount 0 // amount of displays -1
#define switchPin 2

LedControl lc=LedControl(7,5,6, dispAmount);  // Pins: DIN,CLK,CS, # of Display connected
